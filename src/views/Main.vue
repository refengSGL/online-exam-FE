      ...
      <div class="aside" ref="aside">
        ...
        <div class="spread">
          <i
            :class="
              isSpread
                ? 'el-icon-download isPackup'
                : 'el-icon-upload2 isSpread'
            "
            @click="spread"
          ></i>
        </div>
...
export default {
  ...
  async created() {
    if (this.userRole == "teacher") {
      // this.menuTeacher = this.tchNav;
      // this.menu = this.menuTeacher;
      this.menu = this.tchNav;
    } else if (this.userRole == "student") {
      this.menu = this.stuNav;
      // this.menuStudent = this.stuNav;
      // this.menu = this.menuStudent;
    } else {
